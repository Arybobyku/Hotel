    ...
    <div class="w-full px-4">
        <div class="relative flex flex-col min-w-0 break-words w-full mb-2 shadow-lg rounded bg-white">
            ...
            <div class="block w-full overflow-x-auto p-8">
                <form method="POST" action="/hotel/spending/{{ $spending->id }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <label for="jumlah" class="block mb-2 text-sm font-medium text-gray-900 ">Jumlah
                            Barang</label>
                        <input value="{{ $spending->jumlah }}" type="text" id="jumlah" name="jumlah"
                            class="form-control bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5"
                            placeholder="" required>
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Keterangan</label>
                        <input value="{{ $spending->keterangan }}" type="text" id="keterangan" name="keterangan"
                            class="form-control bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5"
                            placeholder="" required>
                    </div>
                    <div class="mb-6">
                        <label class="block mb-2 text-sm font-medium text-gray-900" for="file_input">Upload image</label>
                        <input value="{{ $spending->image }}"

...
<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white md:hidden" x-show="isSideMenuOpen"
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            ...
            @endif
            <li class="relative px-6 py-3">
                <x-nav-link href="/hotel/appreport" :active="request()->routeIs('appreport.index') ||
                    request()->routeIs('appreport.show') ||
                    request()->routeIs('appreport.edit') ||
                    request()->routeIs('appreport.create')">
                    <x-slot name="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"

    ...
    <div class="py-4 text-white">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                <a href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="flex flex-wrap gap-4">
            ...
            <li class="relative px-6 py-3">
                <a href="/dashboard/user" :active="request()->routeIs('/dashboard/user')" class="flex flex-wrap gap-4">
            ...
            <li class="relative px-6 py-3">
                <a href="{{ route('about') }}" :active="request()->routeIs('about')" class="flex flex-wrap gap-4">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                             stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">

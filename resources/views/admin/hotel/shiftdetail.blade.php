        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-2 shadow-lg rounded bg-white">
            ...
            <div class="block w-full overflow-x-auto p-8">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" value="{{ $books->platform->platform_name }}" id="jenisPesan"
                        name="jenisPesan"
                        class="form-control bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5"
                        placeholder="" disabled>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="date" value="{{ $books->book_date }}" id="name" name="name"
                        class="form-control bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5"
                        placeholder="" disabled>
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    <label for="early_checkin" class="block mb-2 text-sm font-medium text-gray-900 ">Early
                        Checkin</label>
                    <input type="text" id="early_checkin" value="{{ $books->early_checkin }}"
                        name="early_checkin"
                        class="form-control bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5"
                        placeholder="Jika Tidak Ada Isi : 0 " disabled>
                </div>

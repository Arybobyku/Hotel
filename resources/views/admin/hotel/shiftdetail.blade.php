    ...
    <div class="w-full px-4">
        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-2 shadow-lg rounded bg-white">
            ...
            <div class="flex  items-center mx-8 mt-10">
                       <a href='/admin/hotel/{{   $user->id_hotel }}/shift' class="text-md font-light text-white bg-blue-800 px-4 py-2 mr-4 rounded-md hover:bg-slate-600">Kembali
  </a>
            ...
            <div class="block w-full overflow-x-auto p-8">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" value="{{ $books->name }}" id="name" name="name"
